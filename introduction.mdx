...
## Welcome to DONNAJAMES Easy!

Discover the path to crafting your very own chatbot with DONNAJAMES Easy, a platform that simplifies the process of chatbot creation and integration.
...
3. **Learn to Use the** DONNAJAMES Easy **API for External Applications:** Expand your chatbot's capabilities by integrating it with external applications.
   We'll guide you through using the DONNAJAMES Easy API, allowing you to interact with your chatbot outside the confines of the platform, providing greater flexibility and control.
...
<CardGroup cols={2}>
  ...
  <Card title="Discover API's" icon="code" href="/api-reference/chatbots/create">
    Interact directly with your DONNAJAMES Easy account and bot settings via API
    endpoints.
  </Card>
  ...
  <Card title="Visit DONNAJAMES Easy Website" icon="browser" href="https://www.donnajames.nl/ai-assistent">
    Review information such as features, use cases, demos, and pricing on our
    app's home page.
  </Card>

  <Card title="Go to our app" icon="computer-classic" href="https://donnajames.app" color="#309C95">
