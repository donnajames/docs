---
title: "Delete Agent"
api: "DELETE https://app.gpt-trainer.com/api/v1/agent/{uuid}/delete"
description: "Delete single agent base on uuid"
---
...
const url = `https://app.gpt-trainer.com/api/v1/agent/${uuid}/delete`;
const headers = {
    'Authorization': 'Bearer <token>'
};
