...
api: "POST https://app.gpt-trainer.com/api/v1/data-sources/url/re-scrape"
...
```bash Curl
curl --location --request POST 'https://app.gpt-trainer.com/api/v1/data-sources/url/re-scrape' \
...
const url = "https://app.gpt-trainer.com/api/v1/data-sources/url/re-scrape";
const headers = {
  "Content-Type": "application/json",
  Authorization: "Bearer <token>",
};
