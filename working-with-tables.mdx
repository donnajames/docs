...
DONNAJAMES Easy currently uses a version of JSON to handle tables. While not perfect, it does support a limited range
...
The static table feature within DONNAJAMES Easy is not optimized for them, and we instead recommend that you look into
function-calling.
...
your DONNAJAMES Easy chatbot as additional RAG context on-demand. However, this requires a bit of programming and server hosting
